    ...
    public function store(Request $request)
    {
        try {
            $request->validate([
                ...
                'attendance.*.present_days' => 'required|integer|min:0',
                'attendance.*.absent_days' => 'required|integer|min:0',
                'attendance.*.leave_days' => 'required|integer|min:0',
            ], [
