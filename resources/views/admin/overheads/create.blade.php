{{-- resources/views/admin/overheads/create.blade.php --}}

@extends('admin.layouts.app')

@section('title', 'Add Overhead')

@section('content')

    <div class="mb-4">
        <div class="row">
            <div class="col-md-10"><h3>Add Overhead</h3></div>
            <div class="col-md-2">
    ...
    <div class="card shadow">
        <div class="card-body">
            <form action="{{ route('admin.overheads.store') }}" method="POST">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea name="comment" rows="3"
                                  ...
                                  placeholder="Optional note...">{{ old('comment') }}</textarea>
                ...
                <button type="submit" class="btn btn-success">
                    <i class="fas fa-save"></i> Save Overhead
                </button>
    ...
    $(document).ready(function () {
        ...
        function toggleDriverDropdown() {
            ...
            if (selectedName === 'welfare') {
                ...
                $('#driverSelect').val(''); // reset driver on hide
            }
        }
        ...
        // On page load — agar old() value hai validation fail k baad
        toggleDriverDropdown();
